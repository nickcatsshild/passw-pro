...
const COOKIE_NAME: &str = "PW_ADMIN";
const ADMIN_PATH: &str = "/admin";
const DT_FMT: &str = "%Y-%m-%d %H:%M:%S %Z";

const BASE_TEMPLATE: &str = "admin/base";

const ACTING_ADMIN_USER: &str = "passw-pro-admin-00000-000000000000";
...
async fn has_http_access() -> bool {
    let Ok(req) = make_http_request(Method::HEAD, "https://github.com/dani-garcia/Passw-pro") else {
        return false;
    };
...
/// Any cache will be lost if Passw-pro is restarted
