Passw-pro tries to prevent security issues but there could always slip something through.
...
- Security issues in any current release of Passw-pro. Source code is available at https://github.com/nickcatsshild/passw-pro. This includes the current `latest` release and `main / testing` release.

# Exclusions

The following bug classes are out-of scope:

- Bugs that are already reported on Passw-pro's issue tracker (https://github.com/nickcatsshild/passw-pro/issues)
- Bugs that are not part of Passw-pro, like on the web-vault or mobile and desktop clients. These issues need to be reported in the respective project issue tracker at https://github.com/bitwarden to which we are not associated
...
- Issues related to software or protocols not under Passw-pro's control
- Vulnerabilities in outdated versions of Passw-pro
...
- Denial of service
- Spamming
- Social engineering (including phishing) of Passw-pro developers, contributors or users

Thank you for helping keep Passw-pro and our users safe!
